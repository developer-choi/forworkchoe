...
import {type ComponentPropsWithRef, useCallback, type MouseEvent, type ComponentPropsWithoutRef} from 'react';
import classNames from 'classnames';
import styles from './index.module.scss';
import LoadingSpinner from '@/components/element/LoadingSpinner';
import CustomLink, {type CustomLinkProps} from '@/components/element/link/CustomLink.tsx';
