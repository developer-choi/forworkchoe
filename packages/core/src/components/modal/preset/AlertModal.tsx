import {type ComposedModalProps, ModalContainer} from '@/components/modal/container.tsx';
import {useCallback} from 'react';
import {DefaultModalHeader} from '@/components/modal/header.tsx';
import {OneButtonModalFooter} from '@/components/modal/footer.tsx';
import DefaultModalBody from '@/components/modal/body.tsx';
import typographyStyles from '@/styles/typography.module.scss';
import type {CloseModalCallback} from '@/hooks/modal.ts';
