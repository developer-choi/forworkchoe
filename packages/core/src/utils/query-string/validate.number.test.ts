import {validateComputableNumber, type ValidateQueryOption} from '@/utils/query-string/validate.ts';
import ValidationError from '@/utils/error/class/info/ValidationError.ts';
