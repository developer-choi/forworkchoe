  ...
  return (
    <div className={styles.wrap}>
      ...
      <footer className={styles.footer}>
        <NavItem href="/layout/mobile-footer/product" enableActive={enableActive} icon={IcAnnounce} text="Product"/>
        <NavItem href="/layout/mobile-footer/event" enableActive={enableActive} icon={IcAnnounce} text="Event"/>
        <NavItem href="/layout/mobile-footer/community" enableActive={enableActive} icon={IcAnnounce} text="Community"/>
        <NavItem href="/layout/mobile-footer/mypage" enableActive={enableActive} icon={IcAnnounce} text="Mypage"/>
      </footer>
    </div>
  );
}
