...
export default forwardRef(function Input({label, error, rightRender, style, className, ...rest}: InputProps, ref: Ref<HTMLInputElement>) {
  return (
    <FormElementWrapper style={style} className={className} kind="input" label={label} error={error}>
